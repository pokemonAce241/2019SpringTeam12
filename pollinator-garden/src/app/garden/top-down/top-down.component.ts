  ...
  ngAfterViewInit() {
    ...
    window.addEventListener("resize", (ev) => {
      ...
      for (var i = 0; i < this.size; i++) {
        this.context.drawImage(this.canvasPlants[i].img, this.imgDims[i].x, this.imgDims[i].y, (this.imgDims[i].y + this.imgDims[i].y * this.sSize), (this.imgDims[i].y + this.imgDims[i].y * this.sSize));
      }
    });
      ...
      .subscribe(res => {
        ...
        this.canvasPlants.forEach((plant, i) => {
          plant.img.onload = () => {
            ...
            this.context.drawImage(plant.img, this.imgDims[i].x, this.imgDims[i].y, (this.imgDims[i].y + this.imgDims[i].y * this.sSize), (this.imgDims[i].y + this.imgDims[i].y * this.sSize));
